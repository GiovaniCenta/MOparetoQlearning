...
class metrics():
    ...
    def plot_pareto_frontier(self):
        ...
        #print(xA0)
        self.plot_p_front(self.xA0,self.yA0,self.zA0,0,"enemy damage","gold gain","gem gain")
        self.plot_p_front(self.xA1,self.yA1,self.zA1,1,"enemy damage","gold gain","gem gain")
        self.plot_p_front(self.xA2,self.yA2,self.zA2,2,"enemy damage","gold gain","gem gain")
        self.plot_p_front(self.xA3,self.yA3,self.zA3,3,"enemy damage","gold gain","gem gain")
